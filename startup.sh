...
default_config='{"pools":[{"url":"stratum.bitcoin.cz:3333","user":"grese.piminer","pass":"schmiles"}],"api-listen":true,"api-port":"4028","expiry":"120","failover-only":true,"log":"5","queue":"2","scan-time":"60","worktime":true,"shares":"0","api-allow":"W:127.0.0.1"}'
